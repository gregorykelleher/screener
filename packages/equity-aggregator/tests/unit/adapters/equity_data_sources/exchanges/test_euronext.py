...
from equity_aggregator.adapters.equity_data_sources.exchanges.euronext.fetch_equities import (
    _build_payload,
    _parse_equities,
    _unique_by_key,
    fetch_equities,
...
# ------------------------------------------------------------------ pagination fan‑out (offline)
@pytest.mark.asyncio
async def test_fetch_equities_pagination_two_pages(respx_mock) -> None:
    """
