...
from equity_aggregator.adapters.equity_data_sources.exchanges.xetra.fetch_equities import (
    _build_payload,
    _parse_equities,
    _unique_by_key,
    fetch_equities,
...
# ------------------------------------------------------------------ pagination branch: one page only
@pytest.mark.asyncio
async def test_fetch_equities_single_page(respx_mock) -> None:
    """
...
# ------------------------------------------------------------------ pagination branch: multi‑page
@pytest.mark.asyncio
async def test_fetch_equities_multi_page(respx_mock) -> None:
    """
