...
from equity_aggregator.domain.resolvers import build_raw_equity
...
# ------------------------------------------------------------------ currency normalised (whitespace + lowercase)
...
# ------------------------------------------------------------------ currency with digit is invalid
...
# ------------------------------------------------------------------ currency longer than 3 chars is invalid
...
# ------------------------------------------------------------------ symbol normalised (whitespace + lowercase)
...
# ------------------------------------------------------------------ scientific notation price is invalid
...
# ------------------------------------------------------------------ thousands separator price is normalised
...
# ------------------------------------------------------------------ currency mixed-case still valid
