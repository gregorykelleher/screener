...
from equity_aggregator.domain.resolvers.exchanges.lse import _convert_gbx_to_gbp
...
# ------------------------------------------------------------------ GBX price auto-converted to GBP
