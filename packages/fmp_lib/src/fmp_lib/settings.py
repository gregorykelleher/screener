...
COMMODITY_VALUES: Dict[str, str] = {
    "ZTUSD": "2-Year T-Note Futures",  # Bonds
    "ZNUSD": "10-Year T-Note Futures",  # Bonds
    "ALIUSD": "Aluminum Futures",  # Metals
    "HGUSD": "Copper",  # Metals
    "GCUSD": "Gold Futures",  # Precious metals
    "SIUSD": "Silver Futures",  # Precious metals
    "RBUSD": "Gasoline RBOB",  # Energy
    "CLUSD": "Crude Oil",  # Energy
    "NGUSD": "Natural Gas",  # Energy
    "BZUSD": "Brent Crude Oil",  # Energy
    "KEUSX": "Wheat Futures",  # Agriculture
    "ZCUSX": "Corn Futures",  # Agriculture
    "LBUSD": "Lumber Futures",  # Agriculture
    "ZOUSX": "Oat Futures",  # Agriculture
    "KCUSX": "Coffee",  # Softs / Agriculture
}
SECTOR_ETF_VALUES: Dict[str, str] = {
    "Basic Materials": "XLB",
    "Technology": "XLK",
    "Energy": "XLE",
}
...
TECHNICAL_INDICATORS_TIME_DELTA_VALUES: List[str] = [
    "1min",
    "5min",
    "15min",
    "30min",
...
SERIES_TYPE_VALUES: List[str] = [
    "line",
]
STATISTICS_TYPE_VALUES: List[str] = [
    "sma",
    "ema",
    "wma",
    "dema",
