...
def _load_equities(conn) -> pd.DataFrame:
    """
    Fetch data from the 'canonical_equities' table,
    select relevant columns, and rename them.
    """
    equities = conn.query("SELECT * FROM canonical_equities")
...
def render_equities(conn) -> None:
    """
    Fetch equities from the 'canonincal_equities' table and render them using AgGrid.
    """
